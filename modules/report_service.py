"""Relatório sono/alimentação: agregação de dados do diário e artefatos (Altair, markdown)."""
...
# Mesmas variáveis de ambiente que `app.py` (teto e faixas de sono no relatório).
...
# API pública (app importa estes nomes)
